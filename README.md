...
[![PyPI](https://img.shields.io/pypi/v/cognis-otelbox.svg)](https://pypi.org/project/cognis-otelbox/)
[![CI](https://github.com/cognis-digital/otelbox/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/otelbox/actions)
...
OTELBOX exists for one job — one-command opentelemetry collector + dashboards bundle — and does it without a SaaS bill or heavyweight setup.
...
```bash
otelbox --version
otelbox scan .                      # scan the current project
otelbox scan . --format json
otelbox scan . --fail-on high       # non-zero exit for CI gates
otelbox mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **LGTM / HyperDX**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`otelbox` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
