#!/usr/bin/env sh
# Universal installer for otelbox. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/otelbox.git"
echo "Installing otelbox ..."
