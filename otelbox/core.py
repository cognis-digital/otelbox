"""OTELBOX core — One-command OpenTelemetry collector + dashboards bundle."""
...
RULES = [
    ("OTE-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("OTE-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("OTE-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
