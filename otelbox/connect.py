"""Native cognis-connect emit for otelbox — forward findings to any platform.

Maps otelbox's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    otelbox ... --format json | otelbox-emit --to stix
    otelbox-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
